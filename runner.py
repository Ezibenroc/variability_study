...
def compile_generic(exec_filename, lib, block_size=128, likwid=None):
    ...
    lib_to_command = {
        'mkl': ['icc', '-DUSE_MKL', c_filename, 'common_matrix.c', '-mkl', '-O3', '-o', exec_filename, *options],
        ...
        'atlas': ['gcc', '-DUSE_ATLAS', c_filename, 'common_matrix.c', '/usr/lib/atlas-base/libcblas.so.3', '-O3', '-o', exec_filename, *options],
        'openblas': ['gcc', '-DUSE_OPENBLAS', c_filename, 'common_matrix.c', '/usr/lib/openblas-base/libblas.so', '-O3', '-o', exec_filename, *options],
